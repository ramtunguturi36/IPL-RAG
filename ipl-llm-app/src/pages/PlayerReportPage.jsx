...
const PlayerReportPage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await cricketApi.getPlayerReport({ playerName: searchQuery });
      ...
      setError(err.message || 'Failed to fetch player report. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="p-6">
      ...
      >
        <div className="flex items-center mb-6">
          <UserIcon className="w-8 h-8 text-ipl-purple mr-3" />
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-6">
          Get detailed reports for any IPL player
        </p>
        ...
        {loading && (
          <div className="text-center py-4">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-300">Generating player report...</p>
          </div>
        )}
